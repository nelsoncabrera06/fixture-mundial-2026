...
export const DICT = {
  es: {
    ...
    "path.outcome.eliminated": "❌ Eliminado del Mundial en fase de grupos",
  ...
  en: {
    ...
    "path.outcome.eliminated": "❌ Eliminated in the group stage",
  ...
  pt: {
    ...
    "path.outcome.eliminated": "❌ Eliminado na fase de grupos",
